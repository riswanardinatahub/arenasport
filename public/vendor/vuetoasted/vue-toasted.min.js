            ...
            (function(n) {
                ...
                (a.defineProperty =
                    ...
                    (a.initSymbolIterator = function() {
                        ...
                        t ||
                            (t = a.global.Symbol.iterator = a.global.Symbol(
                                "iterator"
                            )),
                    ...
                    a.polyfill(
                        ...
                        function(t) {
                            return (
                                t ||
                                function() {
                                    return a.iteratorFromArray(this, function(
                                        t
                                    ) {
                                        return t;
                                    });
                ...
                !(function(n, a) {
                    ...
                    function E(t, e) {
                        ...
                        if (((n = R.pth(t) ? t.totalLength : t), R.col(n)))
                            if (R.rgb(n)) {
                                ...
                                n = R.hex(n) ? u(n) : R.hsl(n) ? l(n) : void 0;
                        else
                            (i = (i = f(n))
                                ...
                                for (i = 0; i < n; i++)
                                    N ||
                                        (N = h(document.body, "transform")
                                            ? "transform"
                                            : "-webkit-transform"),
                                        (d.animatables[i].target.style[N] = r[
                                            i
                                        ].join(" "));
                            (d.currentTime = t),
                                (d.progress = (t / d.duration) * 100);
                        }
                        function o(t) {
                            d[t] && d[t](d);
                        }
                    ...
                    var N,
                        ...
                        R = {
                            ...
                            pth: function(t) {
                                return (
                                    R.obj(t) && t.hasOwnProperty("totalLength")
                                );
                            },
                            svg: function(t) {
            ...
            var u = {},
                ...
                f = function(t) {
                    return (
                        ...
                        (t.closeOnSwipe =
                            void 0 === t.closeOnSwipe || t.closeOnSwipe),
                ...
                p = function(t, e) {
                    ...
                    if (
                        ...
                        u.on("pan", function(t) {
                            var e = t.deltaX;
                            r.classList.contains("panning") ||
                                r.classList.add("panning");
                ...
                d = function(t, e) {
                    if (t.icon) {
                        ...
                        switch (
                            (n.setAttribute("aria-hidden", "true"), t.iconPack)
                        ) {
                            case "fontawesome":
                                n.classList.add("fa");
                            ...
                            case "callback":
                                var a =
                                    t.icon && t.icon instanceof Function
                                        ? t.icon
                                        : null;
                                a && (n = a(n));
                                break;
                ...
                m = function(t, e) {
                    ...
                    return (
                        ...
                        t.onClick &&
                            ...
                            n.addEventListener("click", function(n) {
                                t.onClick &&
                                    (n.preventDefault(), t.onClick(n, e));
                            }),
                        n
                    );
                };
        ...
        function(t, e, n) {
            ...
            !(function(i, o, a, s) {
                ...
                function N(t) {
                    var e = t.length;
                    if (1 === e)
                        return { x: yt(t[0].clientX), y: yt(t[0].clientY) };
                ...
                function V(t, e) {
                    ...
                    return (
                        e & (Pt | Lt) && (n = E(n.concat(r), "identifier", !0)),
                        [n, r]
                    );
                }
                function W() {
                ...
                A.prototype = {
                    ...
                    init: function() {
                        this.evEl &&
                            ...
                            this.evWin &&
                                v(O(this.element), this.evWin, this.domHandler);
                    },
                    destroy: function() {
                        this.evEl &&
                            ...
                            this.evWin &&
                                g(O(this.element), this.evWin, this.domHandler);
                    }
                };
                    ...
                    p(it, rt, {
                        ...
                        getTouchAction: function() {
                            var t = this.options.direction,
                                e = [];
                            return (
                                t & Rt && e.push(ue), t & Ft && e.push(ce), e
                            );
                        },
